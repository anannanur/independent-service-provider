            ...
            <div className='container pb-5'>
                <div className="row mt-5 d-flex justify-content-center align-items-center">
                    <div className="col-md-4 shadow-lg p-3">
                        <h4 style={{ color: '#ea8685' }}>1. Authentication vs Authorization</h4>
                        <p className='text-muted'><span style={{ color: '#ea8685' }}>Ans:</span> Authorization is a system implemented in an app that controls the informative access and limiting actions
                    ...
                    <div className="col-md-4 shadow-lg p-3">
                        <h4 style={{ color: '#ea8685' }}>2. Why are you using firebase? What other options do you have to implement authentication?</h4>
                        <p className='text-muted'><span style={{ color: '#ea8685' }}>Ans:</span> Firebase is a development platform created by Google for building mobile and web applications, that provides
                    ...
                    <div className="col-md-4 shadow-lg p-3">
                        <h4 style={{ color: '#ea8685' }}>3. What other services does firebase provide other than authentication?</h4>
                        <p className='text-muted'><span style={{ color: '#ea8685' }}>Ans:</span> Not only authetication system but also Firebase provides multitude services which have made developers' life easier.
